...
| 2026-02-24T04:08:00Z | Codex | Live pilot harness + ingress hardening | Added `scripts/live_pilot.py` for end-to-end HTTP ingest smoke tests, optional `/sms` API-key enforcement, and localhost-first receiver defaults for laptop-only operation. |
...
- [x] Localhost-only receiver lockdown
